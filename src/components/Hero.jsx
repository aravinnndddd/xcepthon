        ...
        <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
                <motion.div
                    ...
                    className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-goku-orange/30 bg-goku-orange/10 backdrop-blur-md mb-8"
                >
                    <Terminal size={14} className="text-goku-orange" />
                    <span className="text-sm font-sans text-goku-orange-light tracking-widest uppercase">March 23-24, 2026</span>
                </motion.div>
                ...
                >
                    ...
                    <span className="text-transparent bg-clip-text bg-gradient-to-b from-white via-[#f0e6d2] to-[#b3a890] drop-shadow-2xl">
                        XCEPTHON
                    </span>
                    <div className="absolute -inset-x-10  top-1/2 -translate-y-1/2 h-[4px] bg-goku-cyan opacity-80 mix-blend-screen shadow-[0_0_15px_rgba(0,240,255,0.8)] z-20 pointer-events-none scale-x-0 animate-[strike_1s_ease-out_0.8s_forwards]"></div>
                </motion.h1>
                ...
                <motion.p
                    ...
                    className="font-accent text-2xl sm:text-3xl md:text-4xl text-goku-yellow tracking-[0.2em] uppercase mt-2 mb-10 text-glow-yellow"
                >
                ...
                >
                    <button className="group relative px-8 py-4 bg-gradient-to-r from-goku-orange to-goku-orange-light text-white font-heading text-xl tracking-widest skew-x-[-10deg] hover:scale-105 transition-transform duration-300 shadow-[0_0_30px_rgba(255,94,0,0.4)]">
                        <div className="absolute inset-0 bg-white/20 transform scale-x-0 origin-left transition-transform duration-300 ease-out group-hover:scale-x-100 mix-blend-overlay"></div>
