...
const Navbar = () => {
    ...
    return (
        <nav
            className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-goku-dark/95 backdrop-blur-md shadow-[0_4px_30px_rgba(0,0,0,0.3)] border-b border-white/10' : 'bg-transparent'
                }`}
        >
                        ...
                        <div className="px-4 pt-2 pb-6 space-y-1">
                            {navLinks.map((link) => (
                                <a
                                    key={link.name}
                                    href={link.href}
                                    className="block px-3 py-3 text-base font-sans font-medium text-gray-300 hover:text-goku-orange hover:bg-white/5 border-l-2 border-transparent hover:border-goku-orange transition-all"
                            ...
                            <div className="pt-4 px-3">
                                <button className="w-full py-3 bg-goku-orange text-white font-accent tracking-widest text-sm shadow-[0_0_15px_rgba(225,91,10,0.5)]">
                                    REGISTER NOW
                                </button>
                            </div>
                        </div>
